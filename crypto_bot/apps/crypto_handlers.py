...
from crypto_bot.apps import crypto_keyboards as kb
from crypto_bot.apps.info import crypto_information

import requests
import json

from crypto_bot.apps.crypto_keyboards import info_keyboard
...
async def bit_info_get(message: Message):
    await message.answer("Made by artem, with using Binance api")
